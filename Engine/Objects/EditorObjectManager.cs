    ...
    public unsafe class EditorObjectManager
    {
        ...
        public EditorObject Duplicate(EditorObject source)
        {
            var clone = new EditorObject(source.PrimitiveType)
            {
                ...
                TerrainBrushMask = source.TerrainBrushMask,
                TerrainLayerList = source.TerrainLayerList.Select(l => l.Clone()).ToList(),
                TerrainSlopeEnabled = source.TerrainSlopeEnabled,
                TerrainSlopeLayer = source.TerrainSlopeLayer?.Clone(),
