...
namespace DarkEngine3D_gl_csharp.Engine.Config
{
    ...
    public class ShadowPresetData
    {
        ...
        public float SlopeBias { get; set; } = 0.00005f;   // ~4 texels steep (cascade-0 reference)
        public float MinBias { get; set; } = 0.00001f;     // ~2.5 texels flat
        public float GltfConstantBias { get; set; } = 0.00005f;
        public float GltfSlopeBias { get; set; } = 0.00005f; // ~5 texels steep
        public float GltfMinBias { get; set; } = 0.00001f;   // ~2.5 texels flat
        public float BlendRange { get; set; } = 1.0f;
        public float NormalBias { get; set; } = 0.0f; // vertex extrusion (world units, anti-acne)
