...
#pragma warning disable CS0169
                ...
                if (elem.ContentHeight > elem.Height)
                {
                    if (ImGui.CollapsingHeader("Scrollbar", ImGuiTreeNodeFlags.DefaultOpen))
                    {
                        ...
                        ImGui.TextColored(new Vector4(0.6f, 0.7f, 0.8f, 1f),
                            $"Content: {elem.ContentHeight:F0}px  (visible: {elem.Height:F0}px)");
                        ImGui.TextColored(new Vector4(0.6f, 0.7f, 0.8f, 1f),
    ...
    /// <summary>Shared "Texture Settings" editor used by primitives (with UV tiling/offset). Groups:
