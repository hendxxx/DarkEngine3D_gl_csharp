...
public unsafe class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        // Restore the post-processing settings (bloom / tonemap / gamma / depth of
        // field + focus tracking) — without this the Post FX panel reset to defaults
        // every launch even though the sliders persisted values to settings.json.
        // Write-through so settings.json always carries the full field set.
